## How to generate the synthetic datasets used in the Phase-2 for Q3 that assume public sequences constitute immune signals

- This folder contains all the files required to generate the synthetic datasets used in Phase-2 for Q3, where public sequences are assumed to constitute immune signals. The synthetic datasets are generated using the following console script, assuming this python package is installed:

```bash
nohup multi_simairr_var -i q3_fullseq_config.yaml >> stdout.txt 2>> stderr.txt &
```
